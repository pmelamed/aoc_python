...
def main():
    helper.exec_tasks( prepare, task1, task2, helper.read_file( 'data/day24_08.sample' ), 14, 34 )
    helper.exec_tasks( prepare, task1, task2, helper.read_file( 'data/day24_08.in' ), 409, 1308 )
