...
def main():
    exec_task( Data, task1, read_file( 'data/day25_11_1.sample' ), 5 )
    exec_task( Data, task2, read_file( 'data/day25_11_2.sample' ), 2 )
    exec_tasks( Data, task1, task2, read_file( 'data/day25_11.in' ), 534, 499645520864100 )
