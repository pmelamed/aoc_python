...
def main():
    exec_tasks( None, task1, task2, Data( 10, read_file( '../data/samples/year25/day25_08.sample' ) ), 40, 25272 )
    exec_tasks( None, task1, task2, Data( 1000, read_file( '../data/input/year25/day25_08.in' ) ), 112230, 2573952864 )
