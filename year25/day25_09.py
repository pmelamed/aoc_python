...
def main():
    exec_tasks( Data, task1, task2, read_file( '../data/samples/year25/day25_09.sample' ), 50, 24 )
    exec_tasks( Data, task1, task2, read_file( '../data/input/year25/day25_09.in' ), 4749672288, 1479665889 )
