...
def main():
    exec_task( Data, task1, read_file( '../data/samples/year25/day25_03.sample' ), 357 )
    exec_task( Data, task1, read_file( '../data/input/year25/day25_03.in' ), 17332 )
    exec_task( Data, task2, read_file( '../data/samples/year25/day25_03.sample' ), 3121910778619 )
    exec_task( Data, task2, read_file( '../data/input/year25/day25_03.in' ), 172516781546707 )
