...
def main():
    helper.exec_tasks( prepare, task1, task2, helper.read_file( '../data/samples/year24/day24_05.sample' ), 143, 123 )
    helper.exec_tasks( prepare, task1, task2, helper.read_file( '../data/input/year24/day24_05.in' ), 5087, 4971 )
