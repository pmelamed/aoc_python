...
def main():
    helper.exec_tasks( prepare, task1, task2, helper.read_file( '../data/samples/year24/day24_01.sample' ), 11, 31 )
    helper.exec_tasks( prepare, task1, task2, helper.read_file( '../data/input/year24/day24_01.in' ), 765748, 27732508 )
