...
def main():
    ...
    exec_tasks( prepare, task1, task2, read_file( '../data/samples/year24/day24_12.sample' ), 1930, 1206 )
    exec_tasks( prepare, task1, task2, read_file( '../data/input/year24/day24_12.in' ), 1488414, 911750 )
