...
def main():
    exec_tasks( prepare, task1, task2, read_file( '../data/samples/year24/day24_10.sample' ), 36, 81 )
    exec_tasks( prepare, task1, task2, read_file( '../data/input/year24/day24_10.in' ), 682, 1511 )
