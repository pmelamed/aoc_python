...
def main():
    helper.exec_tasks( None, task1, task2, helper.read_file( '../data/samples/year24/day24_04.sample' ), 18, 9 )
    helper.exec_tasks( None, task1, task2, helper.read_file( '../data/input/year24/day24_04.in' ), 2493, 1890 )
