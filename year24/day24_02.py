...
def main():
    helper.exec_tasks( prepare, task1, task2, helper.read_file( '../data/samples/year24/day24_02.sample' ), 2, 4 )
    helper.exec_tasks( prepare, task1, task2, helper.read_file( '../data/input/year24/day24_02.in' ), 534, 577 )
