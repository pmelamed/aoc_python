...
def main():
    exec_task( None, task1, read_file( '../data/samples/year24/day24_15_2.sample' ), 2028 )
    exec_tasks( None, task1, task2, read_file( '../data/samples/year24/day24_15_1.sample' ), 10092, 9021 )
    exec_tasks( None, task1, task2, read_file( '../data/input/year24/day24_15.in' ), 1371036, 1392847 )
