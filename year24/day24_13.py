...
def main():
    exec_tasks( prepare, task1, task2, read_file( '../data/samples/year24/day24_13.sample' ), 480, 875318608908 )
    exec_tasks( prepare, task1, task2, read_file( '../data/input/year24/day24_13.in' ), 34787, 85644161121698 )
