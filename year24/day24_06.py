...
def main():
    helper.exec_tasks( prepare, task1, task2, helper.read_file( '../data/samples/year24/day24_06.sample' ), 41, 6 )
    helper.exec_tasks( prepare, task1, task2, helper.read_file( '../data/input/year24/day24_06.in' ), 5564, 1976 )
