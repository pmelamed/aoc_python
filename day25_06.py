...
def main():
    exec_tasks( Data, task1, task2, read_file( 'data/day25_06.sample' ), 4277556, 3263827 )
    exec_tasks( Data, task1, task2, read_file( 'data/day25_06.in' ), 4405895212738, 7450962489289 )
